...
public abstract class IvyComponent {
	...
	//protected int paddingLeft = 0, paddingTop = 0, paddingRight = 0, paddingBottom = 0;
	...
	public final void setBorderType(int bType){
		/* TODO: modifier lorsque nouvelle valeur */
		if(bType == Border.ROUNDED 
				|| bType == Border.SQUARED 
				|| bType == Border.NONE){
			borderType = bType;
		}
	}
